...
namespace xyLOGIX.Api.Data.Repositories.Interfaces
{
    ...
    /// implements an interface styled after a Repository pattern, but which is really
    /// a Facade for consuming paginated (but potentially infinite) REST API results.
    /// </summary>
    /// <typeparam name="T">
    ...
    /// repository.
    /// <para />
    /// An interface name may be used; implementers must then adapt their methods'
    /// outputs to the interface specified, in this case.
    /// <para />
    ...
    /// throwing <see cref="T:System.NotSupportedException" /> for any of the methods
