...
{
    /// <summary>
    /// Provides functionality that is common to all REST API repository objects.
    /// </summary>
    /// <typeparam name="T">
        ...
        where T : class
    {
        ...
        /// <see
        ///     cref="T:xyLOGIX.Api.Data.Repositories.Interfaces.ApiRepositoryBase" />
        /// and returns a reference to it.
        /// </summary>
        /// <param name="pageSize">
        /// (Optional.) Integer value specifying the number of elements to
        /// obtain at a time while iterating over the collection supplied by the
        /// target REST API.
        /// <para />
